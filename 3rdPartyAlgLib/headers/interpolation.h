...
*************************************************************************/
class MATH_INTERFACE _lsfitreport_owner
{
public:
    _lsfitreport_owner();
...
class MATH_INTERFACE lsfitreport : public _lsfitreport_owner
{
public:
    lsfitreport();
...
*************************************************************************/
class MATH_INTERFACE _lsfitstate_owner
{
public:
    _lsfitstate_owner();
...
class MATH_INTERFACE lsfitstate : public _lsfitstate_owner
{
public:
    lsfitstate();
...
NOTE:       covariance matrix is estimated using  correction  for  degrees
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
MATH_INTERFACE void lsfitlinearw(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, const ae_int_t n, const ae_int_t m, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
MATH_INTERFACE void lsfitlinearw(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
...
*************************************************************************/
MATH_INTERFACE void lsfitcreatewf(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, const double diffstep, lsfitstate &state);
MATH_INTERFACE void lsfitcreatewf(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, const double diffstep, lsfitstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 18.10.2008 by Bochkanov Sergey
*************************************************************************/
MATH_INTERFACE void lsfitcreatef(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, const double diffstep, lsfitstate &state);
MATH_INTERFACE void lsfitcreatef(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, const double diffstep, lsfitstate &state);
...
stopping criterion selection (according to the scheme used by MINLM unit).
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
MATH_INTERFACE void lsfitsetcond(const lsfitstate &state, const double epsf, const double epsx, const ae_int_t maxits);
...
*************************************************************************/
MATH_INTERFACE void lsfitfit(lsfitstate &state,
...
NOTE:       covariance matrix is estimated using  correction  for  degrees
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
MATH_INTERFACE void lsfitresults(const lsfitstate &state, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
...
MATH_INTERFACE void lsfitresults(lsfitstate* state,
     ae_int_t* info,
     /* Real    */ ae_vector* c,
     lsfitreport* rep,
     ae_state *_state);
