...
********************************************************************/
class MATH_INTERFACE ae_vector_wrapper
{
public:
    ae_vector_wrapper();
...
class MATH_INTERFACE real_1d_array : public ae_vector_wrapper
{
public:
    real_1d_array();
...
class MATH_INTERFACE ae_matrix_wrapper
{
public:
    ae_matrix_wrapper();
...
class MATH_INTERFACE real_2d_array : public ae_matrix_wrapper
{
public:
    real_2d_array();
