...
string amySubtractionAlgorithm::GetDescription()
{
	return "Select Cube1 and Cube2, produce Cube1-Cube2";
}
string amySubtractionAlgorithm::GetHint()
{
	return "<a href=www.baidu.com>Test</a>";
}
void amySubtractionAlgorithm::Run()
{
